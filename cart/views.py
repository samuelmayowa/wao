...
def cart_detail(request):
    ...
    if request.method =='POST':
        ...
        if form.is_valid():
            ...
            first_name = form.clearned_data['first_name']
            last_name = form.clearned_data['last_name']
            email = form.clearned_data['email']
            phone = form.clearned_data['phone']
            address = form.clearned_data['address']
            zipcode = form.clearned_data['zipcode']
            place = form.clearned_data['place']
